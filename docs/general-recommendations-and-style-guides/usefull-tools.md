...
Mermaid is a tool for creating **diagrams from** simple **code**. It's *integrated into Github-flavored Markdown* and is a good, easy-to-edit way to visualize structures, databases, tables, and other information.
